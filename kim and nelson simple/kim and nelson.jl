...
function state_space(params)
    # Unpack parameters
    psi1, psi2, sigma_xi2, sigma_kappa2_0, sigma_kappa2_1, sigma_epsilon2, omega, p, q = params
...
function transform_params(params_unbounded, priors)
    # Unpack parameters
    gamma_psi1, gamma_psi2, gamma_sigma_xi2, gamma_sigma_kappa2_0, gamma_sigma_kappa2_1, gamma_sigma_epsilon2, gamma_omega, gamma_p, gamma_q = params_unbounded
    a_psi1, b_psi1, a_psi2, b_psi2, a_xi, b_xi, a_kappa_0, b_kappa_0, a_kappa_1, b_kappa_1, a_epsilon, b_epsilon, a_omega, b_omega, a_p, b_p, a_q, b_q = priors
    ...
    return (psi1, psi2, sigma_xi2, sigma_kappa2_0, sigma_kappa2_1, sigma_epsilon2, omega, p, q)
...
function log_derivatives_params(params_unbounded, priors)
    ...
    return (log_derivative_psi1, log_derivative_psi2, log_derivative_sigma_xi2, log_derivative_sigma_kappa2_0, log_derivative_sigma_kappa2_1, log_derivative_sigma_epsilon2, log_derivative_omega, log_derivative_p, log_derivative_q)
...
function log_prior(theta, priors)
    # Unpack parameters
    psi1, psi2, sigma_xi2, sigma_kappa2_0, sigma_kappa2_1, sigma_epsilon2, omega, p, q = theta
    a_psi1, b_psi1, a_psi2, b_psi2, a_xi, b_xi, a_kappa_0, b_kappa_0, a_kappa_1, b_kappa_1, a_epsilon, b_epsilon, a_omega, b_omega, a_p, b_p, a_q, b_q = priors
    ...
    return log_prior_psi1 + log_prior_psi2 + log_prior_sigma_xi2 + log_prior_sigma_kappa2_0 + log_prior_sigma_kappa2_1 + log_prior_sigma_epsilon2 + log_prior_omega + log_prior_p + log_prior_q 
