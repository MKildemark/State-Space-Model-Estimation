...
function state_space(params, n_order)
    ...
    sigma_epsilon2_0, sigma_epsilon2_1, omega, p, q, sigma_y = params
...
function transform_params(params_unbounded, priors)
    # Unpack parameters
    gamma_rho, gamma_lambda_c, gamma_sigma_xi2, gamma_sigma_kappa2_0, gamma_sigma_kappa2_1, gamma_sigma_epsilon2_0, gamma_sigma_epsilon2_1, gamma_omega, gamma_p, gamma_q, gamma_sigma_y = params_unbounded
    a_rho, b_rho, a_lambda, b_lambda, a_xi, b_xi, a_kappa_0, b_kappa_0, a_kappa_1, b_kappa_1, a_epsilon_0, b_epsilon_0, a_epsilon_1, b_epsilon_1, a_omega, b_omega, a_p, b_p, a_q, b_q, a_sigma, b_sigma = priors
    ...
    return (rho, lambda_c, sigma_xi2, sigma_kappa2_0, sigma_kappa2_1, sigma_epsilon2_0, sigma_epsilon2_1, omega, p, q, sigma_y)
...
function log_derivatives_params(params_unbounded, priors)
    ...
    return (log_derivative_lambda_c, log_derivative_rho, log_derivative_sigma_xi2, log_derivative_sigma_kappa2_0, log_derivative_sigma_kappa2_1, log_derivative_sigma_epsilon2_0, log_derivative_sigma_epsilon2_1, log_derivative_omega, log_derivative_p, log_derivative_q, log_derivative_sigma_y)
...
function log_prior(theta, priors)
    # Unpack parameters
    rho, lambda_c, sigma_xi2, sigma_kappa2_0, sigma_kappa2_1, sigma_epsilon2_0, sigma_epsilon2_1, omega, p, q, sigma_y = theta
    a_rho, b_rho, a_lambda, b_lambda, a_xi, b_xi, a_kappa_0, b_kappa_0, a_kappa_1, b_kappa_1, a_epsilon_0, b_epsilon_0, a_epsilon_1, b_epsilon_1, a_omega, b_omega, a_p, b_p, a_q, b_q, a_sigma, b_sigma = priors
    ...
    return log_prior_rho + log_prior_lambda_c + log_prior_sigma_xi2 + log_prior_sigma_kappa2_0 + log_prior_sigma_kappa2_1 + log_prior_sigma_epsilon2_0 + log_prior_sigma_epsilon2_1 + log_prior_omega + log_prior_p + log_prior_q + log_prior_sigma_y
